    ...
    if(psplit){
      ...
      if(start > 0) {
        if(psplit[start-1].length < 12){
          ...
          psplit[start-1] = '';
          if(start-1 != 0){
            psplit[0] = '<span class="before">'+psplit[0];
          }
        }
        else{
          psplit[0] = '<span class="before">'+psplit[0];
      ...
      if(end < psplit.length-1) {
        if(psplit[end+1].length < 12 || psplit[end].length < 12 ){
          psplit[end] = psplit[end+1] + psplit[end];
          psplit[end+1] = '';
          if(end+1 < psplit.length-1){
            psplit[end+1] = '<span class="after">';
            psplit[psplit.length-1] += '</span>';
          }
        }
        else{
          psplit[end+1] = '<span class="after">'+psplit[end+1];
          psplit[psplit.length-1] += '</span>';
        }
      }
      psplit[start] = '</span><span class="'+classes+'">' + psplit[start];
      psplit[end] += '</span>';
